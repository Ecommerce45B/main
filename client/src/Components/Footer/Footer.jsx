...
const title = "Sobre Tech Store";
const desc = "Tienda en lina dedicada a la venta de equipo de computo y armado.";
        ...
        <div className='footer-bottom'>
            <div className="container">
                <div className="section-wrapper">
                    <p>&copy; 2024<Link to="/">E-Commerce</Link> Creado por <a href='/' target='_blank'>GRUPO 45b</a></p>
